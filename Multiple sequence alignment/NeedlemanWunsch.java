 ...
 * NeedlemanWunsch algorithm. its basically the global alignment algorithm.
 */
public class NeedlemanWunsch {
     ...
     */
    public static double[][] computeMatrix(String sequence1, String sequence2, float matchScore, float mismatchScore, float indelScore) {
        sequence1 = "-" + sequence1;
        sequence2 = "-" + sequence2;

        double[][] resultMatrix = new double[sequence1.length()][sequence2.length()];
    ...
    /**
     * A method for computing the best global alignment for two sequences.
     *
     ...
     * @param indelScore A float representing the score assigned to insertions and deletions.
     */
    public static OptimalAlignment obtainOptimalAlignmentByDownmostOrder(double similarityMatrix[][],
